...
export default function SupportPage() {
	...
	// Update the handleTabChange function to load tickets when the tab is selected
	const handleTabChange = (value) => {
		// If changing to tickets tab, trigger data loading in advance
		if (value === 'tickets') {
			// We could add a loading state here if needed
			console.log('Loading tickets tab');
		}

		// Set the active tab after a short delay for animation
		setTimeout(() => {
			setActiveTab(value);
		}, 50);
	};
