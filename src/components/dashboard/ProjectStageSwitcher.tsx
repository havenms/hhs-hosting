...
export function ProjectStageSwitcher({
	...
	if (!visible) {
		return (
			...
			>
				Show Stage Simulator
			</button>
		);
	}

	return (
		<div className='fixed bottom-4 right-34 z-50 bg-black/80 text-white p-3 text-xs rounded-lg shadow-lg max-w-xs'>
			<div className='flex justify-between items-center mb-2'>
				<span className='font-bold'>Project Stage Simulator</span>
				<button
